...
const listAccpunt = `-- name: ListAccpunt :many
SELECT id, owner, balance, currency, created_at FROM accounts
ORDER BY id
LIMIT $1
OFFSET $2
...
type ListAccpuntParams struct {
	Limit  int32 `json:"limit"`
	Offset int32 `json:"offset"`
}

func (q *Queries) ListAccpunt(ctx context.Context, arg ListAccpuntParams) ([]Accounts, error) {
	rows, err := q.db.QueryContext(ctx, listAccpunt, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
